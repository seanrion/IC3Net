...
class Scenario(BaseScenario):
    ...
    def make_world(self):
        ...
        for i, agent in enumerate(world.agents):
            ...
            agent.size = self.adversary_size if agent.adversary else self.good_size
            agent.accel = self.adversary_accel if agent.adversary else self.good_accel
            #agent.accel = 20.0 if agent.adversary else 25.0
            agent.max_speed = self.adversary_max_speed if agent.adversary else self.good_max_speed
        # add landmarks
